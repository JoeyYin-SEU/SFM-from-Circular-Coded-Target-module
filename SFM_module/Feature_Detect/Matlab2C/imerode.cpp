...
#include "morphop2_halide_imerode_float32_host.h"
#include "rtGetInf.h"
...
//
namespace coder {
void imerode(const ::coder::array<float, 2U> &A, ::coder::array<float, 2U> &B)
{
  ...
  if ((A.size(0) != 0) && (A.size(1) != 0)) {
    ...
    morphop2_halide_imerode_float32_host(
    ...
    s[1] = A.size(1);
    nsize[1] = 3.0;
    erode_real32_ipp(&A[0], &s[0], &bv[0], &nsize[0], &B[0]);
  }
}
